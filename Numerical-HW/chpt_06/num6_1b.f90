...
open(unit=7,file="modeuler1b.dat",form="formatted",status="replace",action="write")
...
open(unit=8,file="ralston1b.dat",form="formatted",status="replace",action="write")
...
open(unit=9,file="rk41b.dat",form="formatted",status="replace",action="write")
