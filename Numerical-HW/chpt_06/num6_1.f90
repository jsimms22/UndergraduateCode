...
open(unit=7,file="modeuler1.dat",form="formatted",status="replace",action="write")
...
open(unit=8,file="ralston1.dat",form="formatted",status="replace",action="write")
...
open(unit=9,file="rk41.dat",form="formatted",status="replace",action="write")
