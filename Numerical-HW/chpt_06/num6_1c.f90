...
open(unit=7,file="modeuler1c.dat",form="formatted",status="replace",action="write")
...
open(unit=8,file="ralston1c.dat",form="formatted",status="replace",action="write")
...
open(unit=9,file="rk41c.dat",form="formatted",status="replace",action="write")
