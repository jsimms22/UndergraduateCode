...
real*8 :: t,y
yprime = 0.0d0
yprime = -5.0d0*y + 5.0d0*t**2.0d0 + 2.0d0*t
return
end
...
open(unit=7,file="modeuler1d.dat",form="formatted",status="replace",action="write")
...
open(unit=8,file="ralston1d.dat",form="formatted",status="replace",action="write")
...
open(unit=9,file="rk41d.dat",form="formatted",status="replace",action="write")
