...
%%
cov1 = cov(PC_Data(:,1:7)');
cov2 = cov(PC_Data(:,8:14)');
...
yClass1 = w' * PC_Data(:,1:7);  %projecting class 1 features onto w
yClass2 = w' * PC_Data(:,8:14); %projecting class 2 features onto w
